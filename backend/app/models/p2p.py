...
class P2PMatch(Base):
    ...
    # Relacionamentos
    reviews = relationship("UserReview", back_populates="match")
    fraud_reports = relationship("FraudReport", back_populates="match")
    feedback = relationship("TradeFeedback", back_populates="match")
