...
# Routers
from app.routers import auth, users, wallet, wallets, tx, prices, prices_batch, health, blockchain, transactions, billing, portfolio, exchange, p2p, chat_enterprise, reputation, dashboard, two_factor, tokens, wallet_transactions, instant_trade
...
app.include_router(prices_batch.router, prefix="/api/v1", tags=["prices"])
