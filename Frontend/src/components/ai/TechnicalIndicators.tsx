    ...
    <div className='space-y-5'>
      ...
      <div className='space-y-4'>
        <div className='flex items-center gap-3 px-1'>
          ...
          <h4 className='text-sm font-bold text-gray-700 dark:text-gray-300'>Momentum</h4>
        </div>

        {/* RSI */}
        <div className={`p-5 rounded-2xl border ${getSignalBg(indicators.momentum.rsi.signal)}`}>
          <div className='flex items-center justify-between mb-3'>
            <span className='text-sm font-bold text-gray-900 dark:text-white'>RSI (14)</span>
            <div className='flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800/50'>
              <SignalIcon signal={indicators.momentum.rsi.signal} />
              <span
                className={`text-xs font-semibold ${getSignalColor(indicators.momentum.rsi.signal)}`}
              >
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='flex-1'>
              <div className='h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden relative'>
                ...
                {/* RSI indicator */}
                <div
                  className={`absolute top-0 bottom-0 w-3 rounded-full transform -translate-x-1/2 shadow-lg ${getRsiIndicatorColor(indicators.momentum.rsi.value)}`}
        ...
        {/* Stochastic */}
        <div
          className={`p-5 rounded-2xl border ${getSignalBg(indicators.momentum.stochastic.signal)}`}
        >
          <div className='flex items-center justify-between mb-3'>
            <span className='text-sm font-bold text-gray-900 dark:text-white'>Stochastic</span>
            <div className='flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800/50'>
              <SignalIcon signal={indicators.momentum.stochastic.signal} />
              <span
                className={`text-xs font-semibold ${getSignalColor(indicators.momentum.stochastic.signal)}`}
              >
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='text-center p-3 bg-white dark:bg-gray-800/50 rounded-xl'>
              <p className='text-xs text-gray-500 dark:text-gray-400 mb-1'>%D</p>
      ...
      <div className='space-y-4'>
        <div className='flex items-center gap-3 px-1'>
          ...
          <h4 className='text-sm font-bold text-gray-700 dark:text-gray-300'>Trend</h4>
        </div>

        {/* Moving Averages */}
        <div className='p-5 rounded-2xl border border-gray-200 dark:border-gray-700/50 bg-white dark:bg-gray-900/80'>
          <span className='text-sm font-bold text-gray-900 dark:text-white'>Moving Averages</span>
        ...
        {/* MACD */}
        <div className={`p-5 rounded-2xl border ${getSignalBg(indicators.trend.macd.trend)}`}>
          <div className='flex items-center justify-between mb-3'>
            <span className='text-sm font-bold text-gray-900 dark:text-white'>MACD</span>
            <div className='flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800/50'>
              <SignalIcon signal={indicators.trend.macd.trend} />
              <span
                className={`text-xs font-semibold ${getSignalColor(indicators.trend.macd.trend)}`}
              >
          ...
          <div className='grid grid-cols-3 gap-3'>
            <div className='text-center p-3 bg-white dark:bg-gray-800/50 rounded-xl'>
              <p className='text-xs text-gray-500 dark:text-gray-400 mb-1'>MACD</p>
              <p
                className={`text-lg font-bold ${indicators.trend.macd.macd >= 0 ? 'text-green-500' : 'text-red-500'}`}
              >
                {indicators.trend.macd.macd.toFixed(2)}
              </p>
            </div>
            <div className='text-center p-3 bg-white dark:bg-gray-800/50 rounded-xl'>
              <p className='text-xs text-gray-500 dark:text-gray-400 mb-1'>Signal</p>
              <p className='text-lg font-bold text-yellow-500'>
                {indicators.trend.macd.signal.toFixed(2)}
              </p>
            </div>
            <div className='text-center p-3 bg-white dark:bg-gray-800/50 rounded-xl'>
              <p className='text-xs text-gray-500 dark:text-gray-400 mb-1'>Histogram</p>
              <p
                className={`text-lg font-bold ${indicators.trend.macd.histogram >= 0 ? 'text-green-500' : 'text-red-500'}`}
              >
      ...
      <div className='space-y-4'>
        <div className='flex items-center gap-3 px-1'>
          ...
          <h4 className='text-sm font-bold text-gray-700 dark:text-gray-300'>Volatility</h4>
        </div>

        {/* Bollinger Bands */}
        <div
          className={`p-5 rounded-2xl border ${getSignalBg(indicators.volatility.bollinger.signal)}`}
        >
          <div className='flex items-center justify-between mb-3'>
            <span className='text-sm font-bold text-gray-900 dark:text-white'>Bollinger Bands</span>
            <div className='flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800/50'>
              <SignalIcon signal={indicators.volatility.bollinger.signal} />
              <span
                className={`text-xs font-semibold ${getSignalColor(indicators.volatility.bollinger.signal)}`}
              >
        ...
        {/* ATR */}
        <div className='p-5 rounded-2xl border border-gray-200 dark:border-gray-700/50 bg-white dark:bg-gray-900/80'>
          <span className='text-sm font-bold text-gray-900 dark:text-white'>ATR (14)</span>
          <div className='grid grid-cols-2 gap-4 mt-4'>
            ...
            <div className='text-center p-4 bg-cyan-500/10 rounded-xl border border-cyan-500/20'>
              <p className='text-xs text-gray-500 dark:text-gray-400 mb-1'>% of Price</p>
      ...
      <div className='space-y-4'>
        <div className='flex items-center gap-3 px-1'>
          ...
          <h4 className='text-sm font-bold text-gray-700 dark:text-gray-300'>Volume</h4>
        </div>

        <div className={`p-5 rounded-2xl border ${getSignalBg(indicators.volume.obv.trend)}`}>
          <div className='flex items-center justify-between mb-3'>
            <span className='text-sm font-bold text-gray-900 dark:text-white'>OBV</span>
            <div className='flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 dark:bg-gray-800/50'>
              <SignalIcon signal={indicators.volume.obv.trend} />
              <span
                className={`text-xs font-semibold ${getSignalColor(indicators.volume.obv.trend)}`}
              >
