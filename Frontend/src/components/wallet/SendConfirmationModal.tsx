...
import { X, AlertCircle, CheckCircle, ArrowRight, Clock, DollarSign, Shield } from 'lucide-react';
...
export const SendConfirmationModal: React.FC<SendConfirmationModalProps> = ({
  ...
  const [selectedFeeLevel, setSelectedFeeLevel] = React.useState<'slow' | 'standard' | 'fast'>('standard');
            ...
            <div className="pt-2 border-t border-blue-200 dark:border-blue-800">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-bold text-blue-600 dark:text-blue-400">
                  {(parseFloat(amount) + parseFloat(String(getFeeForLevel(selectedFeeLevel)))).toFixed(6)} {symbol}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => {
                ...
                if (requires2FA && twoFactorToken.length !== 6) {
