            ...
            <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6'>
              <div className='flex items-start justify-between mb-6'>
                ...
                <div className='text-right'>
                  ...
                  <p className='text-sm text-gray-600 dark:text-gray-400'>por {orderData.coin}</p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4'>
                <div className='relative'>
                  <div className='w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold'>
                    {(orderData.user?.display_name || orderData.user?.username)?.charAt(0) || 'U'}
                  </div>
                ...
                <div className='flex-1'>
                  <div className='flex items-center gap-2 mb-2'>
                    <h4 className='text-xl font-bold text-gray-900 dark:text-white'>
                      {orderData.user?.display_name || orderData.user?.username || 'Anônimo'}
                    </h4>
                ...
                <div className='flex gap-2'>
                  ...
                  <div>
                    ...
                    <p className='text-xs text-orange-700 dark:text-orange-300'>
                      Certifique-se de ter o valor total disponível antes de iniciar o trade. Você
                      terá {orderData.time_limit || 30} minutos para completar o pagamento.
                    </p>
                  </div>
                </div>
              </div>
