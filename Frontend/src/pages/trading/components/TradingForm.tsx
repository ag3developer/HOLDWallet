  ...
  return (
    <div className='bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden'>
      <div className='p-3 sm:p-5 space-y-3 sm:space-y-4'>
        ...
        <div className='flex bg-gray-100 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-1 sm:p-1.5 gap-1'>
          <button
            onClick={() => {
            ...
            className={`flex-1 px-2 sm:px-3 py-2 sm:py-2.5 rounded-md sm:rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 ${
              isBuy
        ...
        <div>
          <div className='flex items-center justify-between mb-1.5 sm:mb-2'>
            <div className='flex items-center gap-1.5 sm:gap-2'>
              ...
              {isBuy && (
                ...
                >
                  <Calculator className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400' />
                </button>
              )}
            </div>
            {!isBuy && (
              <div className='flex items-center gap-2'>
                {walletBalance > 0 ? (
                  <button
                    ...
                    className='text-[10px] sm:text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors font-medium'
                  >
          ...
          <input
            ...
            className='w-full px-3 sm:px-4 py-2.5 sm:py-3 text-base sm:text-lg font-semibold border-2 border-gray-200 dark:border-gray-600 rounded-lg sm:rounded-xl bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-500 transition-all'
          />
        </div>

        {/* Status Message when loading */}
        {loading && (
          <div className='flex items-center gap-2 p-2 sm:p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700'>
        ...
        {isTyping && !loading && amount && Number(amount) > 0 && (
          <div className='flex items-center gap-2 p-2 sm:p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-700'>
            <div className='flex gap-1'>
              <span className='w-1 h-1 sm:w-1.5 sm:h-1.5 bg-yellow-500 rounded-full animate-pulse' />
              <span className='w-1 h-1 sm:w-1.5 sm:h-1.5 bg-yellow-500 rounded-full animate-pulse' />
              <span className='w-1 h-1 sm:w-1.5 sm:h-1.5 bg-yellow-500 rounded-full animate-pulse' />
            </div>
            <span className='text-[10px] sm:text-xs text-yellow-700 dark:text-yellow-400'>
        ...
        {!isBuy && amount && Number(amount) > walletBalance && (
          <div className='p-2 sm:p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-700 space-y-1.5 sm:space-y-2'>
            <div className='flex items-center gap-1.5 sm:gap-2'>
              <svg
                className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-600 dark:text-red-400 flex-shrink-0'
                fill='currentColor'
                viewBox='0 0 20 20'
              >
                <path
