...
const StatCard: React.FC<StatCardProps> = ({
  ...
  const colorClasses = {
    green: 'from-green-900/30 to-green-800/20 border-green-700/30',
    blue: 'from-blue-900/30 to-blue-800/20 border-blue-700/30',
    yellow: 'from-yellow-900/30 to-yellow-800/20 border-yellow-700/30',
    red: 'from-red-900/30 to-red-800/20 border-red-700/30',
    purple: 'from-purple-900/30 to-purple-800/20 border-purple-700/30',
    gray: 'from-gray-800/50 to-gray-700/30 border-gray-600/30',
  }
  ...
  return (
    <div className={`bg-gradient-to-br ${colorClasses[color]} border rounded-lg p-3 sm:p-4`}>
      <div className='flex items-start justify-between'>
        ...
        {trend !== undefined && (
          <div
            className={`flex items-center text-xs ${trend >= 0 ? 'text-green-400' : 'text-red-400'}`}
          >
            {trend >= 0 ? (
      ...
      <div className='mt-3'>
        ...
        <p className='text-xs sm:text-sm text-gray-400 mt-0.5'>{title}</p>
...
export const AdminSecurityPage: React.FC = () => {
  ...
  return (
    <div className='p-3 sm:p-6 space-y-4 sm:space-y-6 bg-gray-900 min-h-screen'>
      {/* Header */}
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <h1 className='text-xl sm:text-2xl font-bold text-white'>Segurança</h1>
      ...
      {(stats?.security_alerts_24h || 0) > 0 && (
        <div className='p-3 sm:p-4 bg-gradient-to-r from-red-900/30 to-orange-900/20 border border-red-700/30 rounded-lg'>
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3'>
            <div className='flex items-center gap-3'>
              <div className='p-2 bg-red-500/20 rounded-lg'>
              ...
              <div>
                <p className='font-medium text-red-300'>Atenção: Alertas de Segurança Detectados</p>
      ...
      <div className='space-y-4'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              ...
              <div className='space-y-3'>
                ...
                <div>
                  <div className='flex justify-between text-xs mb-1'>
                    <span className='text-gray-400'>Cobertura 2FA</span>
                    <span className='text-white font-medium'>{twoFaPercentage}%</span>
                  </div>
                ...
                <div className='grid grid-cols-2 gap-3 mt-4'>
                  <div className='bg-gray-700/30 rounded-lg p-3 text-center'>
                    ...
                    <div className='text-[10px] text-gray-400 mt-1'>Score de Segurança</div>
                  </div>
                  <div className='bg-gray-700/30 rounded-lg p-3 text-center'>
                    <div className='text-2xl font-bold text-blue-400'>SSL</div>
                    <div className='text-[10px] text-gray-400 mt-1'>Certificado Ativo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='bg-gray-800/50 border border-gray-700 rounded-lg p-4'>
              ...
              <div className='grid grid-cols-2 gap-2'>
                <button className='flex items-center gap-2 p-3 bg-gray-700/30 hover:bg-gray-700/50 rounded-lg text-left transition-colors'>
                  <LogOut className='h-4 w-4 text-red-400' />
                  <span className='text-xs text-gray-300'>Logout Geral</span>
                </button>
                <button className='flex items-center gap-2 p-3 bg-gray-700/30 hover:bg-gray-700/50 rounded-lg text-left transition-colors'>
                  <Key className='h-4 w-4 text-blue-400' />
                  <span className='text-xs text-gray-300'>Resetar Tokens</span>
                </button>
                <button className='flex items-center gap-2 p-3 bg-gray-700/30 hover:bg-gray-700/50 rounded-lg text-left transition-colors'>
                  <Database className='h-4 w-4 text-green-400' />
                  <span className='text-xs text-gray-300'>Backup Seguro</span>
                </button>
                <button className='flex items-center gap-2 p-3 bg-gray-700/30 hover:bg-gray-700/50 rounded-lg text-left transition-colors'>
                  <Bell className='h-4 w-4 text-purple-400' />
                  <span className='text-xs text-gray-300'>Alertas</span>
                </button>
              </div>
            </div>
            ...
            <div className='bg-gray-800/50 border border-gray-700 rounded-lg p-4'>
              ...
              {failedLoginsLoading ? (
                  ...
                  {failedLoginsData.items.slice(0, 5).map(login => (
                    ...
                    >
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          <p className='text-xs text-white'>{login.email}</p>
                ...
                <div className='text-center py-6'>
                  ...
                  <p className='text-sm text-gray-400'>Nenhum login falhado recente</p>
                </div>
              )}
            </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className='flex items-center gap-1.5'>
                      ...
                      />
                      <span
                        className={`text-[10px] ${service.status === 'online' ? 'text-green-400' : 'text-red-400'}`}
                      >
        ...
        {activeTab === 'sessions' && (
          <div className='bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden'>
            <div className='p-3 border-b border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
              <h3 className='text-sm font-semibold text-white'>Sessões Ativas</h3>
              <div className='flex items-center gap-2'>
                <div className='relative flex-1 sm:w-64'>
                  ...
                  <input
                    ...
                    className='w-full pl-8 pr-3 py-1.5 bg-gray-700 border border-gray-600 rounded text-xs text-white placeholder-gray-500 focus:outline-none focus:border-blue-500'
                  />
                </div>
              </div>
            </div>
            ...
            {sessionsLoading ? (
                        ...
                        >
                          <td className='py-2 px-3'>
                            <div className='flex items-center gap-2'>
                              ...
                              <span className='text-white'>{session.user_email}</span>
                            </div>
                          </td>
                          <td className='py-2 px-3'>
                            <div className='flex items-center gap-1'>
                              <Globe className='h-3 w-3 text-gray-500' />
                              <span className='text-gray-300 font-mono'>{session.ip_address}</span>
                              <button
              ...
              <div className='text-center py-8'>
                ...
                <p className='text-gray-400 text-sm'>Nenhuma sessão ativa encontrada</p>
              </div>
            )}
          </div>
        )}
        ...
        {activeTab === 'failed-logins' && (
          <div className='bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden'>
            <div className='p-3 border-b border-gray-700'>
              <h3 className='text-sm font-semibold text-white'>Tentativas de Login Falhadas</h3>
            </div>
            ...
            {failedLoginsLoading ? (
              ...
              <>
                    ...
                    <tbody>
                      {failedLoginsData.items.map(login => (
                        <tr
                          ...
                          className='border-t border-gray-700/50 hover:bg-gray-700/20'
                        >
                          <td className='py-2 px-3 text-white'>{login.email}</td>
                          <td className='py-2 px-3'>
                            <span className='text-gray-300 font-mono'>{login.ip_address}</span>
                          </td>
                          <td className='py-2 px-3 text-gray-400 hidden sm:table-cell'>
                            {login.reason}
                          </td>
                          <td className='py-2 px-3 text-gray-400'>{formatDate(login.timestamp)}</td>
                          <td className='py-2 px-3'>
                            <button
                ...
                {failedLoginsData.total > 10 && (
                  <div className='p-3 border-t border-gray-700 flex justify-center items-center gap-2'>
                    <button
                      onClick={() => setFailedLoginsPage(p => Math.max(1, p - 1))}
                      disabled={failedLoginsPage === 1}
                      className='p-1.5 bg-gray-700 rounded disabled:opacity-50 hover:bg-gray-600 transition-colors'
        ...
        {activeTab === 'suspicious' && (
          <div className='bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden'>
            <div className='p-3 border-b border-gray-700'>
              <h3 className='text-sm font-semibold text-white'>Atividades Suspeitas</h3>
            </div>
            ...
            {suspiciousLoading ? (
              ...
              <div className='divide-y divide-gray-700/50'>
                {suspiciousActivities.map(activity => (
                  <div key={activity.id} className='p-3 hover:bg-gray-700/20'>
                      ...
                      <div className='flex items-start gap-3'>
                        ...
                        <div>
                          <div className='flex items-center gap-2 mb-1'>
                            ...
                            {activity.resolved && (
                              <span className='px-2 py-0.5 rounded text-[10px] font-medium bg-green-900/30 text-green-400 border border-green-700/30'>
                                RESOLVIDO
                              </span>
                            )}
                          </div>
              ...
              <div className='text-center py-8'>
                ...
                <p className='text-gray-400 text-sm'>Nenhuma atividade suspeita detectada</p>
        ...
        {activeTab === 'blocked-ips' && (
          <div className='bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden'>
            <div className='p-3 border-b border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
              <h3 className='text-sm font-semibold text-white'>IPs Bloqueados</h3>
            ...
            {blockedIPsLoading ? (
              ...
              <div className='overflow-x-auto'>
                <table className='w-full text-xs'>
                  <thead className='bg-gray-700/30'>
                    <tr>
                      <th className='text-left py-2 px-3 text-gray-400 font-medium'>IP</th>
                      <th className='text-left py-2 px-3 text-gray-400 font-medium'>Motivo</th>
                      <th className='text-left py-2 px-3 text-gray-400 font-medium hidden sm:table-cell'>
                        Bloqueado em
                      </th>
                      <th className='text-left py-2 px-3 text-gray-400 font-medium hidden sm:table-cell'>
                  ...
                  <tbody>
                    {blockedIPs.map(ip => (
                      <tr key={ip.id} className='border-t border-gray-700/50 hover:bg-gray-700/20'>
                        <td className='py-2 px-3'>
                          <div className='flex items-center gap-2'>
                            <span className='text-white font-mono'>{ip.ip_address}</span>
                            {ip.is_permanent && (
                              <span className='px-1.5 py-0.5 rounded text-[9px] font-medium bg-red-900/30 text-red-400 border border-red-700/30'>
                                PERMANENTE
                              </span>
                            )}
                          </div>
                        </td>
                        <td className='py-2 px-3 text-gray-400'>{ip.reason}</td>
                        <td className='py-2 px-3 text-gray-400 hidden sm:table-cell'>
              ...
              <div className='text-center py-8'>
                ...
                <p className='text-gray-400 text-sm'>Nenhum IP bloqueado</p>
              </div>
            )}
          </div>
        )}
