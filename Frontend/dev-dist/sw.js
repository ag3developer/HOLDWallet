...
define(['./workbox-b79e8dca'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.c26fsekor18"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/api/, /^http/, /\.ts$/, /\.tsx$/]
  }));
  workbox.registerRoute(({
    url
  }) => url.pathname.includes("/@") || url.pathname.endsWith(".ts") || url.pathname.endsWith(".tsx") || url.pathname.includes("/src/"), new workbox.NetworkOnly({
    "cacheName": "dev-files",
    plugins: []
  }), 'GET');
  workbox.registerRoute(({
